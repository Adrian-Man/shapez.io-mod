...
export function setupMirrorableSMEC(modInterface) {
    function flipDirectionOverYAxis(direction) {
    ...
    function flipDirectionOverXAxis(direction) {
    ...
    modInterface.extendClass(StaticMapEntityComponent, () => ({
        setMirror(mirrored) {
            this.mirrored = mirrored;
        },

        copyAdditionalStateTo(otherComponent) {
            const SMEC = new StaticMapEntityComponent({
                origin: this.origin.copy(),
                rotation: this.rotation,
                originalRotation: this.originalRotation,
                code: this.code,
            });
            SMEC.setMirror(this.mirrored);
            return SMEC;
        },
        ...
        localDirectionToWorld(direction) {
            ...
            if (!this.mirrored) {
                ...
                return this.rotation % 180 === 0 ? flipDirectionOverYAxis(dir) : flipDirectionOverXAxis(dir);
            }
        },
